...
| `strategies`  | the catalog of structures and reference strategies; each user's strategies and versions; sharing; watchlists; signal evaluation and the signal inbox                                                                             | the structure catalog, strategy versions, signals                                      |
