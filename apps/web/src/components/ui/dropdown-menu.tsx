...
function DropdownMenuLinkItem({
  ...
  // Base UI's ARIA menu pattern gives every item role="menuitem" regardless
  // of the rendered element, so this and MenuPrimitive.Item are equivalent
  // for accessibility; LinkItem is preferred because it renders <a> without
  // composing Item's render prop. closeOnClick defaults to false upstream;
  // this menu closes on navigation like any other item.
  return (
