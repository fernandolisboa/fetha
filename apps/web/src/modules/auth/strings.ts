const en = {
  ...
  verificationEmail: {
    ...
    html: '<p>Hello, {name}.</p><p>Confirm your email to start using Fetha:</p><p><a href="{url}">{url}</a></p>',
  },
  signOut: "Sign out",
};
...
const ptBR = {
  ...
  verificationEmail: {
    ...
    html: '<p>Olá, {name}.</p><p>Confirme seu e-mail para começar a usar o Fetha:</p><p><a href="{url}">{url}</a></p>',
  },
  signOut: "Sair",
} satisfies typeof en;
