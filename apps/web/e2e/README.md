...
`/api/e2e/verification-link`; a single `INSERT`, never an `UPDATE`), backdated to
`decided_at`/`horizon` on the already-ingested session `2026-09-09`, then triggers the nightly
...
same PETR4/`2026-09-09` ingestion precondition.
