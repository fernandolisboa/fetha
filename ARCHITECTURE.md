...
| `decisions`   | `decisions`                                                                                                                         | `recordDecisionAction`, `allowedDecisionKinds`, `deriveDefaultHorizon`, `resolveDefaultHorizon`, `getMyDecisions`, `getMyDecisionForSignal`, `getMyDecisionForOperation`, `DecisionsRepository`, `DecisionBar`, `JournalEntry` / client: `recordDecisionAction`, `allowedDecisionKinds`, `DecisionBar` | `auth`, `market-data`, `strategies`, `portfolio`, `backtests`          |
